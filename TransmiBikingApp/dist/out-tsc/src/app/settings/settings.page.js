...
var SettingsPage = /** @class */ (function () {
    function SettingsPage(alertacontroller, camera, webview, barcodeScanner, flashlight, auth, router) {
    ...
    SettingsPage.prototype.presentAlertConfirm = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertacontroller.create({
                            header: 'Desea salir',
                            buttons: [
                                {
                                    text: 'No',
    ...
    SettingsPage.prototype.takePicture = function () {
        ...
        this.camera.getPicture(options).
            ...
            _this.image = _this.webview.convertFileSrc(ImageData);
        }, function (err) {
            console.log(err);
        });
    };
    ...
    SettingsPage.prototype.activateFlashlight = function () {
        this.flashlight.switchOn();
    };
    SettingsPage.prototype.Onsalir = function () {
        var _this = this;
